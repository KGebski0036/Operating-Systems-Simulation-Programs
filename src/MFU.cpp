...
void MFU::printFooter(size_t numberOfSubstitutes) {
	std::cout << E << YELLOW << "Number of substitutes: " << numberOfSubstitutes << E;
}

void MFU::printStep(size_t needed, size_t missing) {
...
void MFU::saveToFile(std::vector<Page>& pages, std::string& fileToSaveOutput) {
